    ...
    <section className="py-20 bg-slate-50">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-200">
          ...
          {/* Header */}
          <div className="grid grid-cols-[70px_1fr_1.5fr] bg-gradient-to-r from-slate-900 to-blue-900 text-white font-bold">
          ...
          {events.map((item, index) => (
            <div
              key={item.sl}
              className={`grid grid-cols-[70px_1fr_1.5fr] border-b border-slate-200 last:border-b-0 hover:bg-cyan-50 transition-colors ${
                index % 2 === 0 ? 'bg-white' : 'bg-slate-50/70'
              }`}
            >
              <div className="px-3 sm:px-5 py-3 text-center font-semibold text-slate-600">
                {item.sl}
              </div>

              <div className="px-3 sm:px-5 py-3 font-semibold text-slate-800">
                {item.group}
              </div>

              <div className="px-3 sm:px-5 py-3 text-slate-600">
                {item.event}
              </div>
            </div>
          ))}
